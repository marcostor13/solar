...
@Component({
  selector: 'app-casagarbo-blacklist',
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './casagarbo-blacklist.component.html',
  styleUrl: './casagarbo-blacklist.component.scss'
})
export class CasagarboBlacklistComponent {
