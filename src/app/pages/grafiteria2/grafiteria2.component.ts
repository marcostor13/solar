...
@Component({
  selector: 'app-grafiteria2',
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './grafiteria2.component.html',
  styleUrl: './grafiteria2.component.scss',
})
export class Grafiteria2Component {
  ...
  audioPlay() {
    //play desde  0:47
    this.audio.nativeElement.currentTime = 47;
